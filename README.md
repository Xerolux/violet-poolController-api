...
> **📖 Wiki & Documentation:**
> For comprehensive documentation, full usage examples, and all available endpoints, please visit the [Violet Pool Controller API Wiki](WIKI.md).
...
For a full list of available commands and more detailed examples, please refer to the [Wiki](WIKI.md) or the source code in `api.py`.
